...
public:
    ...
    void preorderTraversal(int t)const;
    double preorderTraversalPayroll(int t) const;
...
private:
    ...
    //tree to which p points 
    void preorder(binaryTreeNode<elemType>* p, int t)const;
    double preordercalc(binaryTreeNode<elemType>* p, int t)const;
};
...
template <class elemType>
void binaryTreeType<elemType>::preorderTraversal(int t)const
{
    return preorder(root, t);
}
template <class elemType>
double binaryTreeType<elemType>::preorderTraversalPayroll(int t)const
{
    return preordercalc(root, t);
}
template <class elemType>
...
template <class elemType>
void binaryTreeType<elemType>::preorder(binaryTreeNode<elemType>* p, int t)const
{
    if (p != nullptr)
    {
...
template <class elemType>
double binaryTreeType<elemType>::preordercalc(binaryTreeNode<elemType>* p, int t) const
{
    if (p != nullptr)
    {
...
int binaryTreeType<elemType>::nodeCount(binaryTreeNode<elemType>* p) const
{
    ...
    if (p != NULL)
    {
        return (1 + nodeCount(p->llink) + nodeCount(p->llink));
    }
    else { return 0; }
}
